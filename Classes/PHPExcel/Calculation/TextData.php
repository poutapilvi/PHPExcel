...
class PHPExcel_Calculation_TextData
{
    ...
    private static function unicodeToOrd($c)
    {
        if (ord(substr($c, 0, 1)) >=0 && ord(substr($c, 0, 1)) <= 127) {
            return ord(substr($c, 0, 1));
        } elseif (ord(substr($c, 0, 1)) >= 192 && ord(substr($c, 0, 1)) <= 223) {
            return (ord(substr($c, 0, 1))-192)*64 + (ord(substr($c, 1, 1))-128);
        } elseif (ord(substr($c, 0, 1)) >= 224 && ord(substr($c, 0, 1)) <= 239) {
            return (ord(substr($c, 0, 1))-224)*4096 + (ord(substr($c, 1, 1))-128)*64 + (ord(substr($c, 2, 1))-128);
        } elseif (ord(substr($c, 0, 1)) >= 240 && ord(substr($c, 0, 1)) <= 247) {
            return (ord(substr($c, 0, 1))-240)*262144 + (ord(substr($c, 1, 1))-128)*4096 + (ord(substr($c, 2, 1))-128)*64 + (ord(substr($c, 3, 1))-128);
        } elseif (ord(substr($c, 0, 1)) >= 248 && ord(substr($c, 0, 1)) <= 251) {
            return (ord(substr($c, 0, 1))-248)*16777216 + (ord(substr($c, 1, 1))-128)*262144 + (ord(substr($c, 2, 1))-128)*4096 + (ord(substr($c, 3, 1))-128)*64 + (ord(substr($c, 4, 1))-128);
        } elseif (ord(substr($c, 0, 1)) >= 252 && ord(substr($c, 0, 1)) <= 253) {
            return (ord(substr($c, 0, 1))-252)*1073741824 + (ord(substr($c, 1, 1))-128)*16777216 + (ord(substr($c, 2, 1))-128)*262144 + (ord(substr($c, 3, 1))-128)*4096 + (ord(substr($c, 4, 1))-128)*64 + (ord(substr($c, 5, 1))-128);
        } elseif (ord(substr($c, 0, 1)) >= 254 && ord(substr($c, 0, 1)) <= 255) {
            // error
